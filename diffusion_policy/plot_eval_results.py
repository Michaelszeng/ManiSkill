"""
Plot success rates across action horizons from diffusion_policy/evaluation.py output.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plot success rates across action horizons from diffusion_policy/evaluation.py output."
    )
